    ...
    */
    public static function setNovoChamado($request){
      ...
      try {
        ...
        $corpoEmail = $corpoEmail.'Serviço afetado: '.EntityServico::getServicoPorId($id_servico)->servico_nm.'<BR>';
        $corpoEmail = $corpoEmail.'Tipo de IC afetado: '.EntityTipodeic::getTipodeicPorId($tipodeic)->tipodeic_nm.'<BR>';
        $corpoEmail = $corpoEmail.'Itens do atendimento: '.$itens_checados.'<BR>';
        $corpoEmail = $corpoEmail.'Descrição: '.$descricao.'<BR><BR>';
        $corpoEmail = $corpoEmail.'Login: N/A<BR>';
        $corpoEmail = $corpoEmail.'Matrícula: N/A<BR>';
        ...
        foreach ($posVars['optionsIC'] as $ics) {
          ...
          $sucessoInsertAndamento = $objAndamento->cadastrar();
        }
        ...
        if(!$sucessoInsertAndamento){
          throw new \Exception(' Erro na gravação do andamento. ');
        }
