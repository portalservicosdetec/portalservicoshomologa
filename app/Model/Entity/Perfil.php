...
class Perfil{
   ...
   * @return PDOStatement
   */
  public static function getPerfis($where = null, $order = null, $limit = null, $fields = '*'){
    return (new Database('tb_perfil'))->select($where,$order,$limit,$fields);
  }
  ...
  public static function getQuantidadePerfis($where = null){
    return (new Database('tb_perfil'))->select($where,null,null,'COUNT(*) as qtd')
                                  ->fetchObject()
                                  ->qtd;
  ...
  public static function getPerfil($perfil_id){
    return (new Database('tb_perfil'))->select('perfil_id = '.$perfil_id)
